...
public class HelpScreen extends javax.swing.JFrame {
     ...
     */
    public HelpScreen(String m) //message from the class: Help
    {
        initComponents();
        txaHelp.setText(m); //sets the message onto text area
        txaHelp.setWrapStyleWord(true); //formatting
    }
    ...
    private void initComponents() {
        ...
        txaHelp.setFont(new java.awt.Font("Arial", 0, 20)); // NOI18N
